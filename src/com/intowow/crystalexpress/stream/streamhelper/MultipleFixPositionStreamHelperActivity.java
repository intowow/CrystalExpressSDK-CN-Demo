...
public class MultipleFixPositionStreamHelperActivity extends BaseActivity{
	...
	class BreadcrumbView extends LinearLayout implements OnClickListener {
		...
		public BreadcrumbView(Context context) {
			...
			mlm = LayoutManager.getInstance(MultipleFixPositionStreamHelperActivity.this);
	...
	class SectionPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(View collection, final int position) {
			...
			if (mCanvas.containsKey(position)) {
				...
				//	XXX
				final StreamHelper helper = StreamHelper.getFixPositionStreamHelper(MultipleFixPositionStreamHelperActivity.this, mTagNames[position]);
				...
				final StreamHelperAdapter adapter = new StreamHelperAdapter(
						MultipleFixPositionStreamHelperActivity.this,
						helper,
						items);
