...
public class MultipleFixPositionAdapterActivity extends BaseActivity {
	...
	//	stream ad 
	//
	/**you can setup tag names for your section from the server*/
	private final static String[] mTagNames = Config.STREAM_TAG_NAMES;
	...
	class BreadcrumbView extends LinearLayout implements OnClickListener {
		...
		public BreadcrumbView(Context context) {
			...
			mlm = LayoutManager.getInstance(MultipleFixPositionAdapterActivity.this);
	...
	class SectionPagerAdapter extends PagerAdapter {
		...
		SparseArray<ExtendFixPositionStreamAdapter> mAdapters;
		...
		public SectionPagerAdapter(final Context c, ArrayList<String> sections) {
			...
			mAdapters = new SparseArray<ExtendFixPositionStreamAdapter>();
		}
		...
		public Object instantiateItem(View collection, final int position) {
			...
			if (mCanvas.containsKey(position)) {
				...
				// adapter
				//
				final ExtendFixPositionStreamAdapter adapter = new ExtendFixPositionStreamAdapter(
						MultipleFixPositionAdapterActivity.this,
						mTagNames[position],
						items);
				...
				final ListView listView = new ListView(MultipleFixPositionAdapterActivity.this);
